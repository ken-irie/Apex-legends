...
movie_name = args[1] + ' ' + args[2]
base_img_name = args[3]
start = args[4]
end = args[5]
...
# print(base_img_name)
# print(start,end)
file_path = 'C:\\Users\\kenta\\Desktop\\python\\apex'
...
path = 'C:\\Users\\kenta\\Desktop\\python\\apex'
...
points, average, num = score_shooting(start, end)

print('------------------------------------------')
print('------------------------------------------')
print('データ数：{}'.format(num))
print('合計ポイント：{}'.format(points))
final_average = round(average)
print('最終スコア：{}'.format(final_average))
